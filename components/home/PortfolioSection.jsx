...
<section className={`${styles.portfolio_section} sec_padding`}>
  <div className={`${styles.book} ${styles.book1}`}>
    <Image src="/book-icon-01.png" width={147} height={121} alt="Book Images" className="myImages" />
  </div>
  <div className={`${styles.book} ${styles.book2}`}>
    <Image src="/book-icon-02.png" width={141} height={123} alt="Book Images" className="myImages" />
  </div>
  <div className={`${styles.book} ${styles.book3}`}>
    <Image src="/book-icon-03.png" width={161} height={124} alt="Book Images" className="myImages" />
  </div>
  <div className={`${styles.book} ${styles.book4}`}>
    <Image src="/book-icon-04.png" width={123} height={114} alt="Book Images" className="myImages" />
  </div>
  <div className="container">
    <div className={`${styles.sec_top} text-center`}>
      ...
      <ul className={styles.tabs}>
        ...
        <li key={index} className={index===activeGenre ? styles.activeTab : "" } onClick={()=> setActiveGenre(index)}
          >
          {genre.name}
        </li>
        ))}
  ...
  <Swiper modules={[Navigation, Autoplay]} loop={true} slidesPerView={5} spaceBetween={20} autoplay={{
          delay: 2500,
          disableOnInteraction: false,
        }} className={styles.swiper}>
    {genres[activeGenre].books.map((book, i) => (
    <SwiperSlide key={i}>
      <Image src={book} alt="Portfolio Book" width={320} height={480} />
    </SwiperSlide>
    ))}
  </Swiper>
</section>
